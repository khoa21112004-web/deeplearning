...
def _build_densenet121(use_imagenet_pretrained: bool = True):
...
class Densenet121(nn.Module):
    ...
    def __init__(self, use_imagenet_pretrained: bool = True):
        super().__init__()

        self.axial = _build_densenet121(use_imagenet_pretrained=use_imagenet_pretrained).features
        self.coronal = _build_densenet121(use_imagenet_pretrained=use_imagenet_pretrained).features
        self.sagittal = _build_densenet121(use_imagenet_pretrained=use_imagenet_pretrained).features
